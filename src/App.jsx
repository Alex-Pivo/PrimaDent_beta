          ...
          <div className={style.itemTwo}>
            <div className={style.commentOne}>
              ...
              <p className={style.text}>
                ...
                Миколайовича з приводу лікування карієсу та чистці зубів. Хотіла
                подякувати за якісно надані послуги!
              </p>
              <div className={style.user}>
                <div
                  className={style.box}
            ...
            <div className={style.commentTwo}>
              ...
              <p className={style.text}>
                ...
                переконав. В результаті отримав якісну роботу за вигідною ціною
                та гарантією. Найкраща стоматологія!
              </p>
              <div className={style.user}>
                <div
                  className={style.box}
          ...
          <div className={style.itemThree}>
            ...
            <div className={style.commentTwo}>
              ...
              <p className={style.text}>
                ...
                острі зубчики. Дякую Вам дуже гарно. Ви майстер свого діла.
                Дякую Богу і Вам ,за чудову роботу. Дай Вам Боже здоров ячка .
                Bce оК.
              </p>
              <div className={style.user}>
                <div
